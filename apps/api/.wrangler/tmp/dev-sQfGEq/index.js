...
// .wrangler/tmp/bundle-Hunwxq/checked-fetch.js
...
// .wrangler/tmp/bundle-Hunwxq/strip-cf-connecting-ip-header.js
...
// src/sos.ts
function parseSosCategory(value) {
...
__name(parseSosCategory, "parseSosCategory");
function createSosEvent(category, senderId) {
  return {
...
__name(createSosEvent, "createSosEvent");
function isFallbackRequired(event, startedAt, now = Date.now()) {
  return event.status === "PENDING" && now - startedAt >= 3e4;
}
__name(isFallbackRequired, "isFallbackRequired");

// src/index.ts
var app = new Hono2();
var sosCategorySchema = external_exports.enum(["MEDIS", "BENCANA", "KEAMANAN"]);
...
// .wrangler/tmp/bundle-Hunwxq/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Hunwxq/middleware-loader.entry.ts
